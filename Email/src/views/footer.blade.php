 <!-- /.container-fluid-->
    ...
    <script src="{{URL::asset('smartdata/assets/vendor/datatables/jquery.dataTables.js')}}"></script>
    <script src="{{URL::asset('smartdata/assets/vendor/datatables/dataTables.bootstrap4.js')}}"></script>
    <!-- Custom scripts for all pages-->
    <script src="{{URL::asset('smartdata/assets/js/sb-admin.min.js')}}"></script>
    <!-- Custom scripts for this page-->
    <script src="{{URL::asset('smartdata/assets/js/sb-admin-datatables.min.js')}}"></script>
  </div>
</body>
